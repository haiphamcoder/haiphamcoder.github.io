...
Bây giờ bạn đã sẵn sàng chuyển sang [Chương 2](/vi/blog/git-02-local-repositories), nơi bạn sẽ thực sự biến `rainbow` project directory của mình thành một Git repository và bắt đầu tìm hiểu về các lĩnh vực quan trọng nhất khi làm việc với Git.
