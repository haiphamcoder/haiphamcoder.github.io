...
| Trong chương này, bạn sẽ học cách tích hợp các thay đổi từ nhánh này sang nhánh khác. Trong Git, có hai cách để làm điều này: **merging** (hợp nhất) và **rebasing** (tái cấu trúc cơ sở). Chúng ta sẽ tìm hiểu rebasing ở [Chương 11](/blog/git-11-rebasing); còn bây giờ chúng ta sẽ tập trung vào merging. Chương này sẽ giới thiệu hai loại merge (fast-forward và three-way), và bạn sẽ thực hành loại đầu tiên: fast-forward merge. |
...
Trong [Chương 6](/blog/git-06-hosting-auth), chúng ta sẽ bắt đầu Phần 2: Làm việc với Remote Repository (Hosting Services).
