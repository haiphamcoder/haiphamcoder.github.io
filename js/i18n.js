(function(){
  ...
  const translations = {
    vi: {
      ...
      'cv.projects.xss.title': 'XSS Clean - Java Security Library',
      'cv.projects.xss.desc': 'Thư viện Java toàn diện để sanitize và validate input không tin cậy nhằm ngăn chặn XSS (Cross-Site Scripting) attacks. Cung cấp cả standalone utilities và Spring Boot integration với multiple sanitization strategies, reflection-based cleaning và circular reference protection.',
    ...
    en: {
      ...
      'cv.projects.xss.title': 'XSS Clean - Java Security Library',
      'cv.projects.xss.desc': 'A comprehensive Java library for sanitizing and validating untrusted input to prevent XSS (Cross-Site Scripting) attacks. Provides both standalone utilities and Spring Boot integration with multiple sanitization strategies, reflection-based cleaning and circular reference protection.',
      'cv.projects.github': 'GitHub Repository',
